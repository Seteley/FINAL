...
> **Versión v2 disponible.** Existe una iteración de los modelos que **convive** con la v1
> (objetos con sufijo `_v2`, generados por `sp_etl_predictive_v2`): pronóstico con
> **ARIMA_PLUS_XREG** (regresores de feriado e inversión promocional, AIC mejorado en los 6
> canales) y **segmentación de productos con KMEANS** (4 clusters de portafolio). El
> clasificador de quiebre de v1 se reemplazó porque, sin leakage, los eventos de riesgo no
> tienen señal predecible en estos datos. Ver
> [documentacion_modelos_v2.md](documentacion_modelos_v2.md) y ejecutar con
> `python run_etl_predictive_v2.py`. La sección siguiente describe la v1 original.
